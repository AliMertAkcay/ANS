...
Um die Simulationsergebnisse mit der theoretisch berechneten Übertragungsfunktion sowie den Messergebnissen vergleichen zu können, wurden die in Abbildung @fig-icadBefehl gezeigten Befehle verwendet, um die Rohdaten (RAW-Dateien) der Simulation zu exportieren. Diese Dateien wurden anschließend mithilfe der Python-Bibliothek ltspice eingelesen und weiterverarbeitet, um eine systematische Analyse und Gegenüberstellung der verschiedenen Ergebnisse zu ermöglichen.
