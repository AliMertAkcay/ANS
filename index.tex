...
\NormalTok{plt.plot(fHPFQ1,np.rad2deg(np.unwrap(np.deg2rad(phaseHPFQ1))),label}\OperatorTok{=}\StringTok{\textquotesingle{}Hochpassfilter gemessen Q1\textquotesingle{}}\NormalTok{)}
\CommentTok{\#plt.plot(fHPFQ10,phaseHPFQ10,label=\textquotesingle{}Hochpassfilter gemessen Q10\textquotesingle{})}
\NormalTok{plt.plot(fHPFQ10,np.rad2deg(np.unwrap(np.deg2rad(phaseHPFQ10))),label}\OperatorTok{=}\StringTok{\textquotesingle{}Hochpassfilter gemessen Q10\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.xscale(}\StringTok{\textquotesingle{}log\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.grid()}
\NormalTok{plt.legend()}
\NormalTok{plt.show()}
...
\NormalTok{plt.plot(fButterscipy1uf,phasescipy1uf,label}\OperatorTok{=}\StringTok{"Scipy Übertragungsfunktion"}\NormalTok{)}
\NormalTok{plt.xscale(}\StringTok{\textquotesingle{}log\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.grid()}
\NormalTok{plt.legend()}
\NormalTok{plt.show()}
...
\NormalTok{plt.plot(fButterscipy01uf,gainscipy01uf,label}\OperatorTok{=}\StringTok{"Scipy Übertragungsfunktion"}\NormalTok{)}
\NormalTok{plt.xscale(}\StringTok{\textquotesingle{}log\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.grid()}
\NormalTok{plt.legend()}
\NormalTok{plt.show()}
...
\NormalTok{plt.plot(fButterscipy01uf,phasescipy01uf,label}\OperatorTok{=}\StringTok{"Scipy Übertragungsfunktion"}\NormalTok{)}
\NormalTok{plt.xscale(}\StringTok{\textquotesingle{}log\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.grid()}
\NormalTok{plt.legend()}
\NormalTok{plt.show()}
...
\NormalTok{plt.plot(fButterscipy001uf,gainscipy001uf,label}\OperatorTok{=}\StringTok{"Scipy Übertragungsfunktion"}\NormalTok{)}
\NormalTok{plt.xscale(}\StringTok{\textquotesingle{}log\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.grid()}
\NormalTok{plt.legend()}
\NormalTok{plt.show()}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-21-output-1.png}}
...
\NormalTok{plt.plot(fButterscipy001uf,phasescipy001uf,label}\OperatorTok{=}\StringTok{"Scipy Übertragungsfunktion"}\NormalTok{)}
\NormalTok{plt.xscale(}\StringTok{\textquotesingle{}log\textquotesingle{}}\NormalTok{)}
\NormalTok{plt.grid()}
\NormalTok{plt.legend()}
\NormalTok{plt.show()}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-22-output-1.png}}
...
\NormalTok{            plt.figure(AktuelleFilter)}
\NormalTok{            plt.subplot(}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{)}
\NormalTok{            plt.title(AktuelleFilter)}
            \CommentTok{\#plt.semilogx(freqs, MAG\_dB)}
\NormalTok{            plt.plot(freqsfloat,MAG\_dB)}
\NormalTok{            plt.xscale(}\StringTok{\textquotesingle{}log\textquotesingle{}}\NormalTok{)}
\NormalTok{            plt.grid()}
\NormalTok{            plt.ylabel(}\StringTok{\textquotesingle{}Magnitude in dB\textquotesingle{}}\NormalTok{)}
            \CommentTok{\#}
\NormalTok{            plt.subplot(}\DecValTok{2}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{)}
            \CommentTok{\#plt.semilogx(freqs, PHASE\_deg)}
\NormalTok{            plt.plot(freqsfloat, PHASE\_deg)}
\NormalTok{            plt.xscale(}\StringTok{\textquotesingle{}log\textquotesingle{}}\NormalTok{)}
\NormalTok{            plt.grid()}
\NormalTok{            plt.xlabel(}\StringTok{\textquotesingle{}f in Hz\textquotesingle{}}\NormalTok{)}
\NormalTok{            plt.ylabel(}\StringTok{\textquotesingle{}Phase in deg\textquotesingle{}}\NormalTok{)}
\NormalTok{            plt.savefig(}\StringTok{"./images/Images\_Messautomatisierung/"}\OperatorTok{+}\NormalTok{AktuelleFilter}\OperatorTok{+}\StringTok{".png"}\NormalTok{)}
\NormalTok{plt.show()}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
/tmp/ipykernel_27516/4094528378.py:45: RuntimeWarning: More than 20 figures have been opened. Figures created through the pyplot interface (`matplotlib.pyplot.figure`) are retained until explicitly closed and may consume too much memory. (To control this warning, see the rcParam `figure.max_open_warning`). Consider using `matplotlib.pyplot.close()`.
  plt.figure(AktuelleFilter)
\end{verbatim}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-5.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-6.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-7.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-8.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-9.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-10.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-11.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-12.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-13.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-14.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-15.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-16.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-17.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-18.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-19.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-20.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-21.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-22.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-23.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-24.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-25.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-26.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-27.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-28.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-29.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-30.png}}

\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/cell-23-output-31.png}}
